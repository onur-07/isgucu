  ...
  return (
    <div className="container mx-auto px-4 md:px-6 py-10 md:py-14">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10">
        <div>
          <h1 className="text-3xl md:text-5xl font-black font-heading tracking-tight text-gray-900">
            Blog
          </h1>
          <p className="text-gray-600 font-semibold mt-2 max-w-2xl">
            Freelancerlık, kariyer ve platform rehberleri. Daha iyi teklif ver, daha iyi çalış.
          </p>
        </div>
