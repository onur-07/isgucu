                    ...
                    {formData.subCategory === "Seslendirme" && (
                        <div className="bg-white border-4 border-gray-100 rounded-[3rem] shadow-2xl overflow-hidden flex flex-col md:flex-row min-h-[550px]">
                            ...
                            <div className="w-full md:w-[320px] bg-gray-50/50 border-r-4 border-gray-100 p-6 flex flex-col gap-3">
                                {[
                                    { id: "gender", label: "Seslendirmen", icon: "�" },
                                                ...
                                                <div className="p-6 bg-blue-50/50 rounded-2xl border-2 border-dashed border-blue-200 animate-in fade-in slide-in-from-top-2">
                                                    ...
                                                    <Input
                                                        ...
                                                        onChange={(e) => {
                                                            ...
                                                            const hasExisting = parts.some(p => p && VOICE_OPTIONS.language.includes(p) && p !== "Diğer Diller");
                                                            ...
                                                            if (hasExisting) {
                                                                ...
                                                                console.log("Bazı diller zaten listede var.");
                                                            }
                                                        }}
                                                        className="h-12 border-2 border-white shadow-inner bg-white/80 font-bold"
                                                    />
                                                    {formData.voiceDetails.otherLanguageInput.split(",").some(p => p.trim() && VOICE_OPTIONS.language.includes(p.trim()) && p.trim() !== "Diğer Diller") && (
                                                        <p className="text-[10px] font-bold text-orange-500 mt-2">Girdiğiniz bazı diller zaten listede mevcut, lütfen onları listeden seçin.</p>
                                                    )}
                                                </div>
                                            )}
                                        </div>
            ...
            {step === 4 && (
                <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-500">
                    ...
                    <div className="space-y-6 pt-10">
                        <h4 className="text-xl font-bold text-gray-900 font-heading tracking-tight">İş İlanı Ekstraları</h4>
